...
static constexpr auto qt_meta_stringdata_CLASSPage_LoginENDCLASS = QtMocHelpers::stringData(
    "Page_Login",
    "sendLoginSuccess",
    "",
    "auth",
    "on_btn_login_clicked",
    "on_btn_exist_clicked"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSPage_LoginENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSPage_LoginENDCLASS_t qt_meta_stringdata_CLASSPage_LoginENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "Page_Login"
        QT_MOC_LITERAL(11, 16),  // "sendLoginSuccess"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 4),  // "auth"
        QT_MOC_LITERAL(34, 20),  // "on_btn_login_clicked"
        QT_MOC_LITERAL(55, 20)   // "on_btn_exist_clicked"
    },
    "Page_Login",
    "sendLoginSuccess",
    "",
...
void Page_Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendLoginSuccess((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->on_btn_login_clicked(); break;
        case 2: _t->on_btn_exist_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Page_Login::*)(bool );
...
// SIGNAL 0
void Page_Login::sendLoginSuccess(bool _t1)
{
